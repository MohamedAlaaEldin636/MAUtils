...
fun FileSpec.Builder.addFullImportStringsList(list: List<String>) {
 ...
 * - [Set]
 */
internal fun TypeName.convertJavaClassTypeNameToKClassTypeNameIsa(): TypeName {
    return when (this) {
        ...
        Set::class.java.asTypeName() -> Set::class.asTypeName()
        else -> this
    }
}
