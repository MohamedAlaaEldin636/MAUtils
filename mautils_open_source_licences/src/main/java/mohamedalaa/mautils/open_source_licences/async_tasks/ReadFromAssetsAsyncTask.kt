...
package mohamedalaa.mautils.open_source_licences.async_tasks
...
import mohamedalaa.mautils.open_source_licences.extensions.indexOfOrNull
...
END OF TERMS AND CONDITIONS
    ...
    override fun doInBackground(vararg params: Void?): List<Licence>? {
        ...
        val mautilsLicenceContent = THIS_LIBRARY_LICENCE_CONTENT
