...
import mohamedalaa.mautils.mautils.module_gson_processor.root.getAllEligibleClassesFromAnnotation
...
class AboutReflectionTest {
    ...
    fun annotation_nesting_and_typeParams() {
        val listOfClassesToBeAnnotated = getAllEligibleClassesFromAnnotation(
