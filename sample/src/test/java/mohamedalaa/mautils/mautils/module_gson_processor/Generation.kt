...
class Generation {
    ...
    @Test
    fun objReflection() {
        val kClass = Class.forName("mohamedalaa.mautils.mautils.module_gson_processor.AAAA").kotlin
        println(kClass.declaredMemberProperties.toList()[0].call(kClass.objectInstance))

        /*println(Class.forName("mohamedalaa.mautils.mautils.module_gson_processor.AAAA")
